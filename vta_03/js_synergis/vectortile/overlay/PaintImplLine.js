...
define(["require", "exports", "../../util/Uid", "../data/DataType", "../../util/Color", "../data/TreeDataImpl", "./BasePaint"], function (require, exports, Uid_1, DataType_1, Color_1, TreeDataImpl_1, BasePaint_1) {
    ...
    var PaintImplLine = /** @class */ (function (_super) {
        ...
        function PaintImplLine(layerSet, paintSet, width, opacity) {
            ...
            _this.treeDataItem = new TreeDataImpl_1.TreeDataImpl(DataType_1.DataType.get(DataType_1.DataType.INDEX___________PAINT), _this.getId(), 'line', -1, Color_1.Color.mapContentIconNode(), paintSet.getExtent(), null);
            ...
            var dimensionTreeDataItem = new TreeDataImpl_1.TreeDataImpl(DataType_1.DataType.get(DataType_1.DataType.INDEX_STYLE_DIMENSION), Uid_1.Uid.random16(), 'line-width', width, Color_1.Color.mapContentIconNode(), paintSet.getExtent(), null);
