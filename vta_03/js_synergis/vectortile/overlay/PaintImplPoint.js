...
define(["require", "exports", "../../util/Uid", "../data/DataType", "../../util/Color", "../data/TreeDataImpl", "./BasePaint"], function (require, exports, Uid_1, DataType_1, Color_1, TreeDataImpl_1, BasePaint_1) {
    ...
    var PaintImplPoint = /** @class */ (function (_super) {
        ...
        function PaintImplPoint(layerSet, paintSet, radius, opacity) {
            ...
            _this.color = Color_1.Color.parseHex('#FF0000'); //paintSet.getColor();
            _this.styleLayer = {
                id: _this.getId(),
                type: 'circle',
                source: 'syn',
            ...
            _this.treeDataItem = new TreeDataImpl_1.TreeDataImpl(DataType_1.DataType.get(DataType_1.DataType.INDEX___________PAINT), _this.getId(), 'vertices', -1, Color_1.Color.mapContentIconNode(), paintSet.getExtent(), null);
            ...
            var opacityTreeDataItem = new TreeDataImpl_1.TreeDataImpl(DataType_1.DataType.get(DataType_1.DataType.INDEX___STYLE_OPACITY), Uid_1.Uid.random16(), 'opacity', opacity, Color_1.Color.mapContentIconNode(), paintSet.getExtent(), null);
            _this.treeDataItem.addChild(opacityTreeDataItem);
            var dimensionTreeDataItem = new TreeDataImpl_1.TreeDataImpl(DataType_1.DataType.get(DataType_1.DataType.INDEX_STYLE_DIMENSION), Uid_1.Uid.random16(), 'radius', radius, Color_1.Color.mapContentIconNode(), paintSet.getExtent(), null);
