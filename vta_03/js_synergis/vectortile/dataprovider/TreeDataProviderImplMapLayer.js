define(["require", "exports", "../data/DataType", "../../util/Color", "../data/TreeDataImpl"], function (require, exports, DataType_1, Color_1, TreeDataImpl_1) {
    ...
    exports.TreeDataProviderImplMapLayer = void 0;
    /**
    ...
    var TreeDataProviderImplMapLayer = /** @class */ (function () {
        ...
        TreeDataProviderImplMapLayer.prototype.getTreeData = function () {
            return new TreeDataImpl_1.TreeDataImpl(DataType_1.DataType.get(DataType_1.DataType.INDEX______MAP__LAYER), this.getId(), this.layer.title, -1, Color_1.Color.mapContentIconNode(), this.layer.fullExtent, null);
        };
