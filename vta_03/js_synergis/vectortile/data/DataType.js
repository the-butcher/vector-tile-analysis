define(["require", "exports", "../../layout/IconConstants", "../../layout/LayoutSlider", "../../layout/TreeIconNode", "../../layout/TreeIconNodeImpl", "../../util/Color", "../overlay/PaintType", "../VectorTileAnalysisApp"], function (require, exports, IconConstants_1, LayoutSlider_1, TreeIconNode_1, TreeIconNodeImpl_1, Color_1, PaintType_1, VectorTileAnalysisApp_1) {
    ...
    exports.DataType = exports.DataTypeUnknown = exports.DataTypeStyleDimension = exports.DataTypeStyleOpacity = exports.DataTypeStyleColor = exports.DataTypeStyleLayer = exports.DataTypePaintSet = exports.DataTypeLayerSet = exports.DataTypeMapLayer = exports.DataTypeExtent = exports.DataTypeTags = exports.DataTypeValue = exports.DataTypeValues = exports.DataTypeKey = exports.DataTypeKeys = exports.DataTypeName = exports.DataTypeVersion = exports.DataTypePoint = exports.DataTypePolyline = exports.DataTypePolygon = exports.DataTypeVectorTileLayer = exports.DataTypeVectorTile = void 0;
    ...
    var DataTypeStyleOpacity = /** @class */ (function () {
        ...
        DataTypeStyleOpacity.prototype.getIconNode = function (treeData) {
            return new TreeIconNodeImpl_1.TreeIconNodeImpl('', IconConstants_1.IconConstants.ICON_LOW_VISION, 'scale(0.8)', '0px', Color_1.Color.mapContentIconNode());
        };
    ...
    var DataTypeStyleDimension = /** @class */ (function () {
        ...
        DataTypeStyleDimension.prototype.getIconNode = function (treeData) {
            return new TreeIconNodeImpl_1.TreeIconNodeImpl('', IconConstants_1.IconConstants.ICON_ARROW_UP_DOWN, 'scale(0.38) translate(0px, -10px)', '0px', Color_1.Color.mapContentIconNode());
        };
