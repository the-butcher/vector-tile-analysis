define(["require", "exports", "../util/Color", "../vectortile/dataprovider/TreeDataVectorTileLoader", "./VectorTileLayerSyn", "./ActiveTileLayerSyn", "./BoundariesLayerSyn", "../vectortile/VectorTileAnalysisApp", "../vectortile/data/TreeDataImpl", "../vectortile/data/DataType", "../vectortile/tilemap/QuadKeyImpl", "./BoundaryFields"], function (require, exports, Color_1, TreeDataVectorTileLoader_1, VectorTileLayerSyn_1, ActiveTileLayerSyn_1, BoundariesLayerSyn_1, VectorTileAnalysisApp_1, TreeDataImpl_1, DataType_1, QuadKeyImpl_1, BoundaryFields_1) {
    ...
    var LayerSetImpl = /** @class */ (function () {
        ...
        LayerSetImpl.prototype.getTreeData = function () {
            var treeData = new TreeDataImpl_1.TreeDataImpl(DataType_1.DataType.get(DataType_1.DataType.INDEX_______LAYER_SET), this.id, this.title, -1, Color_1.Color.mapContentIconNode(), this.vectorBaseLayer.fullExtent, null);
            if (this.vectorUserLayer != null) {
                var treeDataVectorUser_1 = new TreeDataImpl_1.TreeDataImpl(DataType_1.DataType.get(DataType_1.DataType.INDEX______MAP__LAYER), this.vectorUserLayer.id, this.vectorUserLayer.title, -1, Color_1.Color.mapContentIconNode(), this.vectorUserLayer.fullExtent, null);
            ...
            var treeDataVectorBase = new TreeDataImpl_1.TreeDataImpl(DataType_1.DataType.get(DataType_1.DataType.INDEX______MAP__LAYER), this.vectorBaseLayer.id, this.vectorBaseLayer.title, -1, Color_1.Color.mapContentIconNode(), this.vectorBaseLayer.fullExtent, null);
